...
class ListGenerator {
    ...
    void buildValueDefinition(ObjectMapper listMapper, ArrayNode titlesMap, String value) {
    ...
    void buildValues(ObjectMapper listMapper, ArrayNode titlesMap, Class<? extends ValuesContainer> valuesContainer) {
        try {
